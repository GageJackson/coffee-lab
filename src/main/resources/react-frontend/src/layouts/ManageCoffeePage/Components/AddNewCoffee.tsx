...
import AddCoffeeRequest from '../../../models/AddCoffeeRequest';
...
export const AddNewCoffee = () => {
    ...
    async function submitNewCoffee() {
        const url = `http://localhost:8080/api/admin/secure/add/coffee`;
        if (authState?.isAuthenticated && title !== '' && author !== '' && category !== 'Category' 
            && description !== '' && copies >= 0) {
                const coffee: AddCoffeeRequest = new AddCoffeeRequest(title, author, description, copies, category);
                coffee.img = selectedImage;
                ...
                const submitNewCoffeeResponse = await fetch(url, requestOptions);
                if (!submitNewCoffeeResponse.ok) {
                    ...
                    <form method='POST'>
                        <div className='row'>
                            ...
                            <div className='col-md-3 mb-3'>
                                ...
                                <ul id='addNewCoffeeId' className='dropdown-menu' aria-labelledby='dropdownMenuButton1'>
                        ...
                        <div>
                            <button type='button' className='btn btn-primary mt-3' onClick={submitNewCoffee}>
                                Add Coffee
                            </button>
                        </div>
                    </form>
